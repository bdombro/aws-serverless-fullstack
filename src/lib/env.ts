...
const lambdaVars = ['cookieSecret', 'dbName', 'dbArn', 'dbSecretArn', 's3Bucket'] as const
const lambdaEnv = pick(pe, lambdaVars)
const localVars = ['ADDRESS', 'PORT', 'cookieSecret', 'dbName', 'dbHost', 'dbUser', 'dbPassword'] as const
